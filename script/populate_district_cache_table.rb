...
def all_cache_keys
  %w(ratings feed_test_scores district_schools_summary directory_census district_directory feed_district_characteristics test_scores_gsdata feed_test_scores_gsdata)
end
