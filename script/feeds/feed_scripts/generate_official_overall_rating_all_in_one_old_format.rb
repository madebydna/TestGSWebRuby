...
module Feeds
  class GenerateOfficialOverallRatingFeedAllInOneOldStyle
    def initialize(path)
      @path = path
    end
    ...
    def file_header
      <<~HEADER
        ...
        <gs-official-overall-rating-feed xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.greatschools.org/feeds/gs-official-overall-rating.xsd">
      HEADER
    end

    def file_footer
      "</gs-official-overall-rating-feed>"
    end
...
if ARGV[0]
  Feeds::GenerateOfficialOverallRatingFeedAllInOneOldStyle.new(ARGV[0]).generate
  exit 0
else
