...
class FeedConfig
  ...
  def local_gs_subrating_feed_files
    @state_abbreviations.map { |state| "local-gs-subrating-feed-#{state}.xml" }
  end

  def all_feed_files
    local_feed_files + local_new_test_feed_files + local_gs_new_test_subgroup_feed_files +
    official_overall_rating_feed_files + parent_review_feed_files + local_gs_subrating_feed_files
  end
  ...
  def all_flat_feed_files
    parent_reviews_flat_feed_files + parent_ratings_flat_feed_files + local_new_test_flat_feed_files +
      ...
      local_greatschools_feed_flat_files + local_greatschools_census_feed_flat_files
  end
