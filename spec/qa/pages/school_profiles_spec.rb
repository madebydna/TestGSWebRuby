...
describe 'School profiles page', remote: true do
  ...
  describe 'submitting reviews' do
    # Don't tag tests that write reviews to DB as safe_for_prod
    describe 'while registering', type: :feature do
    ...
    describe 'as a registered user' do
      pending 'Needs tests for submitting reviews as registered users'
    end
  end
  ...
  describe 'General information' do
    ...
    it 'should have a link to the OSP page' do
      pending "due to intermittent failures"
