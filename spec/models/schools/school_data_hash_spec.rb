...
describe SchoolDataHash do
  ...
  let(:school) { FactoryBot.create(:school, name: school_name, type: school_type, level: "9,10,11,12") }
        ...
        '4-year high school graduation rate' => [
          {
            ...
            "performance_level_2013" => "above_average"
          }.symbolize_keys,
        ],
        'Percent of students who meet UC/CSU entrance requirements' => [
          {
            ...
            "performance_level" => "above_average",
            "performance_level_2014" => "above_average"
          }.symbolize_keys,
        ]
      }
    }
