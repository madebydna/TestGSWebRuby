...
programs_partners_value = "{ heading: 'Detroit Partners', subheading: 'more partner info', resources: [  { heading: 'Facebook Aquires Greatschools', content: 'For 1 bagillion dollars' }, { heading: 'Facebook Aquires Greatschools', content: 'For 1 bagillion dollars' } ] }"
