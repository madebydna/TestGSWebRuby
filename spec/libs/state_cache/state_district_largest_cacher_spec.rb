...
describe StateDistrictLargestCacher do
  describe '#district_characteristics' do
    ...
    before do
      @district = FactoryGirl.create_on_shard(:ca, :district)
      @district2 = FactoryGirl.create_on_shard(:ca, :district)
      @district_cache = FactoryGirl.create(:district_cache, state: 'ca', district_id: @district.id, name: 'district_characteristics')
    end
