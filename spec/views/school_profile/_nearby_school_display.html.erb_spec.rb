...
describe 'deprecated_school_profile/_nearby_school_display' do
  ...
  context 'with ads not turned off' do
    ...
    before do
      ...
      stub_template  "deprecated_school_profile/_nearby_school.html.erb" => "this content"
      allow_any_instance_of(SchoolProfileDecorator).to receive(:school_zip_location_search_url).and_return("url")
      @show_ads = true
      render partial: "deprecated_school_profile/nearby_school_display", locals: {title: "Nearby schools", schools: [mocked_school]}
    end
