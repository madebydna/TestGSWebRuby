...
describe 'data_layouts/_bar_chart.html.erb' do
  ...
  it "doesn't error when data is empty" do
    ...
    expect do
      render partial: 'data_layouts/bar_chart', locals: { category: category_placement.category, category_placement: category_placement, data: data }
