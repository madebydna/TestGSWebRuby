...
//                tooltip: { isHtml: true },
    ...
    var drawBarChartTestScoresStacked = function (barChartData, divId, chartname) {
      var func = function () {
        ...
        dataTable.addColumn('number', GS.I18n.t('data_layouts.test_scores.proficient'));
        dataTable.addColumn({'type': 'string', 'role': 'annotation'});
        dataTable.addColumn({'type': 'string', 'role': 'tooltip', 'p': {'html': true}});
        dataTable.addColumn('number', GS.I18n.t('data_layouts.test_scores.advanced'));
        dataTable.addColumn({'type': 'string', 'role': 'annotation'});
        dataTable.addColumn({'type': 'string', 'role': 'tooltip', 'p': {'html': true}});
    ...
    var drawBarChartTestScores = function (barChartData, divId, chartname) {
        var func = function () {
            ...
            dataTable.addColumn('string', 'year');
            dataTable.addColumn('number', GS.I18n.t('data_layouts.test_scores.proficient_or_better'));
            dataTable.addColumn({'type': 'string', 'role': 'annotation'});
            dataTable.addColumn({'type': 'string', 'role': 'tooltip', 'p': {'html': true}});
