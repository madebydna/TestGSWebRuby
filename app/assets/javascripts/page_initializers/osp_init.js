$(function() {
  if (gon.pagename == 'Osp') {
    ...
    GS.forms.elements.setEnableDisableElementsAndInputsHandler(
      '.js-ospQuestionsContainer'
    );
    ...
    GS.forms.elements.disableTargetElementsIfTriggerEmpty(
      '.js-conditionalQuestion'
    );
    GS.forms.elements.setCustomSubmitHandler(
      '.js-submitTrigger',
      'ospPage',
      '.js-ospNav',
      function(e, $form) {
