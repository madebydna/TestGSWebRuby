class SchoolCache < ActiveRecord::Base
  ...
  KEYS = [:characteristics, :esp_responses, :nearby_schools, :progress_bar, :ratings, :ratings2, :reviews_snapshot, :test_scores ,:feed_test_scores, :directory, :feed_characteristics]
