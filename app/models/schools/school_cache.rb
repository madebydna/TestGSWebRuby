class SchoolCache < ActiveRecord::Base
  ...
  KEYS = %i(characteristics esp_responses nearby_schools progress_bar ratings reviews_snapshot test_scores feed_test_scores directory feed_characteristics courses test_scores_gsdata)
