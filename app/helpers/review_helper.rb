...
module ReviewHelper
  ...
  def question_response_column_klass_key(response_count)
    # klass_key = {
    #     "2" => ["col-xs-6 col-lg-6","col-xs-6 col-lg-6"],
    #     "3" => ["col-xs-4 col-lg-4","col-xs-4 col-lg-4","col-xs-4 col-lg-4"],
    #     "4" => ["col-xs-6 col-sm-3","col-xs-6 col-sm-3","col-xs-6 col-sm-3","col-xs-6 col-sm-3"],
    #     "5" => ["col-xs-4 col-sm-2 col-sm-offset-1","col-xs-4 col-sm-2","col-xs-4 col-sm-2",:clearfix,"col-xs-4 col-sm-2","col-xs-4 col-sm-2"]
    ...
    #
    # # {
    # #     2 => { xs:4, lg: 6, offset: 3. clearfix: true }, { xs:4, lg: 6, offset: 3. clearfix: true },
    # # }
    # }
