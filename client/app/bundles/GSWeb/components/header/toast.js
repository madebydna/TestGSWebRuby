...
const init = () => {
  ...
  const suppressToast = window.location.pathname === '/' || window.location.pathname.includes('/gk/coronavirus-school-closure-support/') || window.location.pathname.includes('/gk/recursos-durante-coronavirus/') || window.location.pathname.includes('/newsletter/') || window.location.pathname.includes('/boletin/');
