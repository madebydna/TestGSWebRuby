...
} from '../components/autocomplete/autocomplete_typeahead_callbacks';
/*!
 * typeahead.js 0.10.2
...
//  https://github.com/twitter/typeahead.js/issues/647
    ...
    var html = {
        ...
        dropdown: '<span class="tt-dropdown-menu notranslate"></span>',
        ...
        return function hightlight(o) {
            ...
            function hightlightTextNode(textNode) {
                ...
                if (match = regex.exec(textNode.data)) {
                    let wrapperNode = doc.createElement(o.tagName);
...
//              ModifiedBehavior
                ...
                let onUpKeyedCallback = getOnUpKeyedCallback();

                if (onUpKeyedCallback !== undefined) {
                    onUpKeyedCallback.call(this, query)
                } else {
...
//              ModifiedBehavior
                var query = this.input.getQuery();
                let onDownKeyedCallback = getOnDownKeyedCallback();

                if (onDownKeyedCallback !== undefined) {
                    onDownKeyedCallback.call(this, query)
                } else {
//                    Default library Behavior
//                    var query = this.input.getQuery();
...
//                ModifiedBehavior
                let onQueryChangedCallback = getOnQueryChangedCallback();

                if (onQueryChangedCallback !== undefined) {
                    onQueryChangedCallback.call(this, query)
                } else {
//                  Default library Behavior
