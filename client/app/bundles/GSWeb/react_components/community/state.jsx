...
import Toc from './toc';
import { schoolsTocItem, academicsTocItem, awardWinningSchoolsTocItem, studentsTocItem, schoolDistrictsTocItem, reviewsTocItem, AWARD_WINNING_SCHOOLS, STUDENTS, ACADEMICS, SCHOOL_DISTRICTS, REVIEWS } from './toc_config';
...
class State extends React.Component {
  ...
  selectTocItems(){
    let stateTocItems = [schoolsTocItem, awardWinningSchoolsTocItem, academicsTocItem, schoolDistrictsTocItem, studentsTocItem, reviewsTocItem];
