...
import Toc from './toc';
import { schoolsTocItem, awardWinningSchoolsTocItem, schoolDistrictsTocItem, reviewsTocItem, AWARD_WINNING_SCHOOLS, SCHOOL_DISTRICTS, REVIEWS } from './toc_config';
...
class State extends React.Component {
  ...
  selectTocItems(){
    let stateTocItems = [schoolsTocItem, awardWinningSchoolsTocItem, schoolDistrictsTocItem, reviewsTocItem];
