...
import Toc from './toc';
import { browseSchools, schoolDistricts, reviews, BROWSE_SCHOOLS, SCHOOL_DISTRICTS, REVIEWS } from './toc_config';
...
class State extends React.Component {
  ...
  selectTocItems(){
    let stateTocItems = [browseSchools, schoolDistricts, reviews];
