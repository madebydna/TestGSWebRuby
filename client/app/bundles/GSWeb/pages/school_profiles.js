...
$(function() {
  ...
  $('#close-school-tour').click(function(){
    ...
    $('.tour-teaser').tipso({content: '<div class="school-profile-tour-modal"><div><h3>Welcome!</h3>You&apos;re seeing our new, improved GreatSchools School Profile.</div><br/><button class="tour-cta js-start-tour active">Start tour</button></div>', width: 300, tooltipHover: true});
