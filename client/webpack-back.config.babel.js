...
const config = {
  ...
  entry: {
    server: ['./app/bundles/GSWeb/server'],
  },
...
if (devBuild) {
  console.log('Webpack backend dev build for Rails'); // eslint-disable-line no-console
  ...
  console.log('Webpack backend production build for Rails'); // eslint-disable-line no-console
}
// config["externals"] = {
//   jquery: 'jQuery',
