  ...
  class SummaryRating
    ...
    def equity
      if @equity_overview.has_rating?
        ...
        {title: 'Equity adjustment factor', rating: '<span class="gs-rating circle-rating--xtra-small checkmark"></span>', weight: get_weight('Summary Rating Weight: Equity Adjustment Factor')}
      end
    end
