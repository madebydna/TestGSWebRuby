module SchoolProfiles
  class TestScoresComponent < ::SchoolProfiles::Component
    def narration
      I18n.t('RE Test scores narration', scope: 'lib.equity_gsdata', subject: data_type) # TODO: update scope after moving translations
    end
