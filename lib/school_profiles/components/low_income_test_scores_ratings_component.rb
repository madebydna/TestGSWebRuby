    ...
    class LowIncomeTestScoresRatingsComponent < Component
      ...
      def narration
        ...
        t(narration_rating, scope: 'lib.equity_gsdata.LI Test scores overview narration',
          subject: t(data_type), more: SchoolProfilesController.show_more, end_more: SchoolProfilesController.show_more_end) # TODO: update scope after moving translations
      end
