class DirectoryCensusCaching::DirectoryCensusCacher < Cacher
  ...
  def district_directory_query
    @_district_directory_query ||= (
    {
        city: district.city,
        county: school.county,
        fax: school.fax,
        fipscounty: District.FIPScounty,
        lat: school.lat,
        level: school.level,
        level_code: school.level_codes,
        lon: school.lon,
        name: district.name,
        nces_code: school.nces_code,
        phone: school.phone,
        state: school.state,
        state_id: school.state_id,
        street: school.street,
        universal_id: nil, # need to make this
        url: nil, # need to make this - maybe a url helper,
        web_site: school.home_page_url,
        zip: school.zipcode
    }
    )
  end
