...
class TestScoresCaching::TestScoresCacherGsdata < Cacher
  ...
  def query_results
    @query_results ||= Omni::TestDataValue.web_by_school(school.state, school.id)
  end

  def state_results_hash
    @_state_results_hash ||= begin
      state_values = Omni::TestDataValue.web_by_state(school.state)
  ...
  def district_results_hash
    @_district_results_hash ||= begin
      district_values = Omni::TestDataValue.web_by_district(school.state, school.district_id)
