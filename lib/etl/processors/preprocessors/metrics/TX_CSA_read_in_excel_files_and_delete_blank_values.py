...
raw_DistrictDataDownloadFile = pd.read_excel(
    "District_Data_Download_4yr_2018_v2.xlsx", sheet_name="Comp_2018_4yr"
)
raw_CampusDataDownloadFile = pd.read_excel(
    "Campus_Data_Download_4yr_2018_v2.xlsx", sheet_name="Comp_2018_4yr"
)
...
transposed_ACTDistrictFile = pd.melt(
    raw_ACTDistrictFile,
...
transposed_ACTCampusFile = pd.melt(
    raw_ACTCampusFile,
...
transposed_SATDistrictFile = pd.melt(
    raw_SATDistrictFile,
    id_vars=["Group", "District", "DistName", "Grads_Mskd", "Exnees_Mskd"],
...
transposed_SATCampusFile = pd.melt(
    raw_SATCampusFile,
    id_vars=["Group", "Campus", "CampName", "Grads_Mskd", "Exnees_Mskd"],
    value_vars=["ERW", "Math", "Total", "Part_Rate", "Above_Crit_Rate"],
)
...
transposed_DistrictDataDownloadFile = pd.melt(
    raw_DistrictDataDownloadFile,
    id_vars=[
        "CALC_FOR_STATE_ACCT",
        "DISTRICT",
        "DISTNAME",
...
transposed_CampusDataDownloadFile = pd.melt(
    raw_CampusDataDownloadFile,
    id_vars=[
        "CALC_FOR_STATE_ACCT",
        "CAMPUS",
        "CAMPNAME",
...
transposed_ACTDistrictFile.to_csv(
    "transposed_ACTDistrictFile.txt", index=None, sep="\t"
)
transposed_ACTCampusFile.to_csv("transposed_ACTCampusFile.txt", index=None, sep="\t")
transposed_SATDistrictFile.to_csv(
    "transposed_SATDistrictFile.txt", index=None, sep="\t"
)
transposed_SATCampusFile.to_csv("transposed_SATCampusFile.txt", index=None, sep="\t")
transposed_CampusDataDownloadFile.to_csv(
    "transposed_CampusDataDownloadFile.txt", index=None, sep="\t"
)
transposed_DistrictDataDownloadFile.to_csv(
    "transposed_DistrictDataDownloadFile.txt", index=None, sep="\t"
)
