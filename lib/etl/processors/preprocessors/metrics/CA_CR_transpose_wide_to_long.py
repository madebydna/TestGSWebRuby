...
transposed_cohort1819_df = pd.melt(
    cohort1819_df,
    id_vars=[
        "AcademicYear",
        "AggregateLevel",
...
transposed_act19_df = pd.melt(
    act19_df,
    id_vars=["CDS", "CDCode", "RType", "SName", "DName", "NumTstTakr"],
    value_vars=[
        "AvgScrRead",
        "AvgScrEng",
        "AvgScrMath",
...
transposed_cgr12mo18_df = pd.melt(
    cgr12mo18_df,
    id_vars=[
        "AcademicYear",
        "AggregateLevel",
