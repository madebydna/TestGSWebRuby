...
class LATestProcessor2015LEAPiLEAPEOCPARCC < GS::ETL::TestProcessor
  ...
  source("2015_PARCC.txt",[],col_sep: "\t") do |s|
   ...
   def config_hash
   {
       source_id: 28,
       state: 'la',
       notes: 'DXT-1583 LA LEAP, iLEAP, EOC, PARCC 2015',
       url: 'http://doe.state.la.us/',
       file: 'la/DXT-1583/2015/la.2015.2.public.charter.[level].txt',
       level: nil,
...
LATestProcessor2015LEAPiLEAPEOCPARCC.new(ARGV[0],max:nil).run
