...
class NDTestProcessor2017NDSA < GS::ETL::TestProcessor
  ...
  source("District_Level_NDSA_17.txt",[], col_sep: "\t") do |s|
   s.transform("Fill values", Fill,{
  ...
  def config_hash
    {
        ...
        file: 'nd/2017/output/nd.2017.1.public.charter.[level].txt',
        level: nil,
...
NDTestProcessor2017NDSA.new(ARGV[0], max: nil).run