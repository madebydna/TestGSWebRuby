...
class LATestProcessor2013LEAPiLEAPEOC < GS::ETL::TestProcessor
  ...
  source("2013_EOC.txt",[],col_sep: "\t") do |s|
   ...
   def config_hash
   {
       source_id: 28,
       state: 'la',
       notes: 'DXT-1583 LA LEAP, iLEAP, EOC 2013',
       url: 'http://doe.state.la.us/',
       file: 'la/DXT-1583/2013/la.2013.2.public.charter.[level].txt',
       level: nil,
...
LATestProcessor2013LEAPiLEAPEOC.new(ARGV[0],max:nil).run
