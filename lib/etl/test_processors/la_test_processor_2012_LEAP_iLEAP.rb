...
class LATestProcessor2012LEAPiLEAP < GS::ETL::TestProcessor
  ...
  source("2012_iLEAP.txt",[],col_sep: "\t") do |s|
   ...
   def config_hash
   {
       source_id: 28,
       state: 'la',
       notes: 'DXT-1583 LA LEAP, iLEAP 2012',
       url: 'http://doe.state.la.us/',
       file: 'la/DXT-1583/2012/la.2012.2.public.charter.[level].txt',
       level: nil,
...
LATestProcessor2012LEAPiLEAP.new(ARGV[0],max:nil).run
