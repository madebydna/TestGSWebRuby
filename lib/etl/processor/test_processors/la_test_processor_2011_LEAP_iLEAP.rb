...
class LATestProcessor2011LEAPiLEAP < GS::ETL::TestProcessor
  ...
  source("2011_iLEAP.txt",[],col_sep: "\t") do |s|
   ...
   def config_hash
   {
       source_id: 28,
       state: 'la',
       notes: 'DXT-1583 LA LEAP, iLEAP 2011',
       url: 'http://doe.state.la.us/',
       file: 'la/DXT-1583/2011/la.2011.2.public.charter.[level].txt',
       level: nil,
...
LATestProcessor2011LEAPiLEAP.new(ARGV[0],max:nil).run
