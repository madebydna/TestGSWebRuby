module CachePopulator
  class SchoolCachePopulator < Base
    CACHE_KEYS = %w(
      ratings characteristics esp_responses reviews_snapshot nearby_schools gsdata feed_characteristics directory courses test_scores_gsdata feed_test_scores_gsdata feed_old_test_scores_gsdata
    )
