module CommunityProfiles
  class AcademicProgress
    ...
    def sources
      ...
      content << rating_source(year: source_info["year"], label: I18n.t('Great schools rating', scope: "lib.academic_progress"),
    ...
    def data_values
      ...
      {}.tap do |h|
        ...
        h['toc_item'] = I18n.t('toc_item', scope: "lib.academic_progress.district_scope")
