module CommunityProfiles::DistanceLearningConfig
  ...
  HEALTH_AND_SAFETY_MAIN_SUBTAB_ACCESSORS = [
    DISTRICT_REQUIRES_FACE_MASKS,
    DISTRICT_COMMUNICATES_CHANGES_TO_BUILDING_HEALTH_SANITATION_AND_PROTOCOLS,
    DISTRICT_COMMUNICATES_CHANGES_TO_BUILDING_PRACTICES_FOR_ALL_SCHOOLS_TO_ENSURE_PHYSICAL_DISTANCING,
    DISTRICT_COMMUNICATES_EXPECTATION_THAT_HEALTH_AND_SAFETY_DATA_WILL_BE_SHARED_WITH_FAMILIES,
    DISTRICT_HAS_A_PLAN_OR_POLICY_FOR_DETERMINING_FUTURE_ROLLING_CLOSURES_IF_CONFIRMED_INFECTION_OF_STAFF_OR_STUDENTS
  ]
