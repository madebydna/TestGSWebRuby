class StateCacher
  ...
  # Known data types:
  # :state_characteristics, :test_scores_gsdata, :feed_test_scores_gsdata, :feed_test_scores_description_gsdata
  ...
  def self.cacher_for(key)
    {
        ...
        feed_test_scores_description_gsdata: TestScoresCaching::Feed::FeedStateTestDescriptionCacherGsdata,
    }[key.to_s.to_sym]
  end
